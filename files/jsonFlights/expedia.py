...
if __name__=="__main__":
	...
	month = date[0:2]
	day = date[3:5]
	# name_of_file = '%s-%s-flight-%s%s%s.json'%(source,destination,year,month,day)	
	with open('files/jsonFlights/%s-%s-%s%s%s.json'%(source,destination,year,month,day),'w') as fp:
